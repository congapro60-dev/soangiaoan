# SmartPlan AI — Codex Working Guidelines
...
**AI Providers**: Gemini, Codex, OpenAI, Grok, DeepSeek — via `src/lib/aiProviders.ts`
...
This workspace supports full E2E Browser Automation and Direct Hook control using Puppeteer. Any AI session (Gemini, Codex, Roo Code, etc.) can hook into and control Google Chrome to perform tests, inspect the DOM, and verify features.
...
- **Read Guidelines**: The AI must always check `AGENTS.md` to discover project commands.
