...
- [ ] **Step 1: Viết tài liệu Dashboard (`docs/features/01-dashboard.md`)**
  Tài liệu phải mô tả:
...
- [ ] **Step 2: Viết tài liệu Thư viện học liệu (`docs/features/03-library.md`)**
  Tài liệu phải mô tả:
...
- [ ] **Step 3: Viết tài liệu Quản lý lớp học (`docs/features/09-classes.md`)**
  Tài liệu phải mô tả:
...
- [ ] **Step 4: Chạy kiểm tra định dạng Markdown**
...
- [ ] **Step 1: Viết tài liệu Soạn giáo án (`docs/features/02-creator-lesson-plan.md`)**
  Tài liệu phải mô tả:
...
- [ ] **Step 2: Viết tài liệu Soạn đề kiểm tra (`docs/features/04-testing-exam.md`)**
  Tài liệu phải mô tả:
...
- [ ] **Step 3: Viết tài liệu Công cụ AI nâng cao (`docs/features/08-ai-tools.md`)**
  Tài liệu phải mô tả:
...
- [ ] **Step 4: Viết tài liệu Trợ lý Chat đa nhiệm (`docs/features/10-chat-copilot.md`)**
  Tài liệu phải mô tả:
...
- [ ] **Step 1: Viết tài liệu Chấm điểm AI (`docs/features/05-grading.md`)**
  Tài liệu phải mô tả:
...
- [ ] **Step 2: Viết tài liệu Kỳ thi trực tuyến (`docs/features/06-exams.md`)**
  Tài liệu phải mô tả:
...
- [ ] **Step 3: Viết tài liệu Học tập thích ứng (`docs/features/07-adaptive-learning.md`)**
  Tài liệu phải mô tả:
...
- [ ] **Step 4: Viết tài liệu Quản lý Mẫu & Khung cấu trúc (`docs/features/11-templates-skeletons.md`)**
  Tài liệu phải mô tả:
