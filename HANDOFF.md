...
- **Chưa làm:** GĐ4 xuất file Drive "Sxxxxx - Tên.xlsx".
- Nghiệm thu: competency/portfolio 25 test + gradingPrompt 97 + grade-homework.competency 4 + projection 2 + full `lint`(tsc) 0, `build` PASS.
