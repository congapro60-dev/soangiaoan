...
export interface TvLiveViewProps { definition: TvLiveDefinition; sessionId: string; publicState: LivePublicState; }

export const TvLiveView = ({ definition, sessionId, publicState }: TvLiveViewProps) => {
  const [stats, setStats] = useState<LivePublicStats | null>(null);
  const [error, setError] = useState<string | null>(null);
  useEffect(() => subscribeToLivePublicStats(sessionId, setStats, nextError => setError(nextError.message)), [sessionId]);
