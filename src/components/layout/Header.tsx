...
type ActiveTab = 'dashboard' | 'classes' | 'creator' | 'library' | 'chat' | 'templates' | 'testing' | 'grading' | 'exams' | 'adaptiveLessons' | 'aiTools' | 'aiBilling' | 'admin';
...
export const Header = ({ activeTab, data, setIsSettingsOpen, setActiveTab, onMenuClick }: HeaderProps) => {
  ...
  const getTitle = () => {
    switch (activeTab) {
      ...
      case 'aiBilling': return 'Chi phí AI';
