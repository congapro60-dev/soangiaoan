...
3. HÀNH ĐỘNG SƯ PHẠM VÀ GIÁO DỤC PHẨM CHẤT (DANIELSON & CIS BẮT BUỘC):
Tại cột "Hoạt động GV & HS" và trong quá trình thiết kế bài tập thực tế, hãy khéo léo lồng ghép và **ghi rõ hiển thị vào ngoặc vuông** các yếu tố sau:
  a. Kỹ thuật quản lý lớp:
  - [Quét Radar] (GV đi vòng quanh bao quát lớp, hỗ trợ kịp thời)
  - [Khen ngợi phi ngôn ngữ] (Thumbs up, gật đầu mỉm cười)
  - [Phản hồi Feed-forward] (Dùng bút nhớ/màu nhấn vào lỗi sai để HS tự tư duy sửa lại)
  - [Đánh giá đồng đẳng] (Đổi bài chấm chéo bằng bút Xanh Lá Cây - Green pen)
  
  b. Thẩm thấu Phẩm chất cốt lõi:
  - [🌐 Công dân toàn cầu]: Lồng ghép bối cảnh quốc tế vào bài toán (Ví dụ: Số liệu LHQ, thị trường chứng khoán quốc tế, mục tiêu phát triển bền vững...).
  - [💻 Công dân kỹ thuật số]: Tích hợp hoặc nhắc nhở hành vi sử dụng công cụ số có đạo đức, văn minh (Ví dụ: Yêu cầu dùng phần mềm GeoGebra/Desmos kiểm chứng kết quả; dặn dò trích dẫn nguồn dữ liệu thống kê trên internet).
  - [🌍 Học tập liên văn hóa]: Đưa yếu tố tôn trọng đa văn hóa vào tình huống (Ví dụ: Kiến trúc hình học của các nền văn hóa khác nhau, các đơn vị đo lường quốc tế). Khuyến khích góc nhìn đa chiều từ HS.
...
6. YÊU CẦU ĐỘ DÀI KIẾN TẠO (CHỐNG LÀM ẨU):
- TUYỆT ĐỐI KHÔNG ĐƯỢC rút gọn độ dài các luồng đối thoại GV/HS khi chuyển sang định dạng "Nhiều bảng". 
- BẠN BẮT BUỘC PHẢI duy trì phong độ viết kịch bản dài, diễn đạt cặn kẽ từng hoạt động, lời giảng, câu hỏi. Một giáo án hoàn chỉnh phải dài và dày dặn như thật (tương đương 1500 - 2500 từ).
===========================================================
      ` : '';
